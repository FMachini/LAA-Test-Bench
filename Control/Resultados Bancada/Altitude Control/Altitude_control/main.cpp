...
clock_t t0, tend; 
int numStates{4},numInput{2},numTrack{2}; // number of states, inputs and tracking variables
mat Ctrout(2,1);
mat Duty(2,1);
mat Ref(2,1);
...
int main()
{
    ...
    sysParam>> Ref(0,0); // altitude reference value
    sysParam>> Ref(1,0); // inclination reference value
    sysParam.close();
