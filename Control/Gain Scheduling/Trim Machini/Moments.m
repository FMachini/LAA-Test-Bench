...
for i = 1:n
    ...
    Tx = ((alpha_d(i)+Q)*cos(alpha(i))*cos(beta(i)) - (R-sin(alpha(i)))*(-cos(gamma(i))*sin(beta(i))+sin(gamma(i))*sin(alpha(i))*cos(beta(i))))*omg(i)*JJm(i);
    
    Ty = ((-cos(alpha(i))*beta_d(i)+P)*cos(alpha(i))*cos(beta(i)) - (R-sin(alpha(i)))*(-sin(gamma(i))*sin(beta(i))+cos(gamma(i))*sin(alpha(i))*cos(beta(i))))*omg(i)*JJm(i);
    
    Tz = ((-cos(alpha(i))*beta_d(i)+P)*(-cos(gamma(i))*sin(beta(i))+sin(gamma(i))*sin(alpha(i))*cos(beta(i))) - (alpha_d(i)+Q)*cos(alpha(i))*cos(beta(i))*...
        sin(gamma(i))*sin(beta(i))+cos(gamma(i))*sin(alpha(i))*cos(beta(i)))*omg(i)*JJm(i);
