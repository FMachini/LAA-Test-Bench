...
%% Função de custo
fun = @(x)1*(x(1)^2 + x(2)^2 + x(3)^2 + x(4)^2) + 100000*(x(5)^2 + x(6)^2 + x(7)^2 + x(8)^2);  
...
% options = optimoptions('fmincon','Algorithm','sqp','MaxIterations',10000,'MaxFunctionEvaluations',10000)
%% 
% Solve the problem. 
nonlcon = @minharest;
