...
subplot(2,2,2)
plot([1:kend].*Ts,xp(7,1:end-1).*180/pi, 'LineWidth',2)
...
subplot(2,2,4)
plot([1:kend].*Ts,xp(8,1:end-1).*180/pi, 'LineWidth',2)
...
figure
subplot(2,2,1)
plot([1:kend].*Ts, xp(1,1:end-1), 'LineWidth',2)
...
subplot(2,2,3)
plot([1:kend].*Ts, xp(2,1:end-1), 'LineWidth',2)
