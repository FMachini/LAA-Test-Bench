...
x_sim = param_sim(:,[1:6])*rad2deg;
u_sim = param_sim(:,[7:11]);
chi_sim = param_sim(:,[12:end])*rad2deg;
%**************************************************************************
...
%grafico da posicao
subplot(3,2,1);
plot(k,ref(:,1)*rad2deg,'m-.','LineWidth',2);
hold on
plot(k,(chiKK(:,1)+chiKK(:,7))*rad2deg,'b-','LineWidth',2);
hold on
plot(k,xAux(:,1)*rad2deg,'r--','LineWidth',2);
...
subplot(3,2,3);
plot(k,ref(:,2)*rad2deg,'m-.','LineWidth',2);
hold on
plot(k,(chiKK(:,2)+chiKK(:,8))*rad2deg,'b-','LineWidth',2);
hold on
plot(k,xAux(:,2)*rad2deg,'r--','LineWidth',2);
...
subplot(3,2,5);
plot(k,ref(:,3)*rad2deg,'m-.','LineWidth',2);
hold on
plot(k,(chiKK(:,3)+chiKK(:,9))*rad2deg,'b-','LineWidth',2);
hold on
plot(k,xAux(:,3)*rad2deg,'r--','LineWidth',2);
...
subplot(3,2,2);
plot(k,xAux(:,4)*rad2deg,'r--','LineWidth',2);
hold on
plot(k,chiKK(:,4)*rad2deg,'b-','LineWidth',2);
hold on
...
subplot(3,2,4);
plot(k,xAux(:,5)*rad2deg,'r--','LineWidth',2);
hold on
plot(k,chiKK(:,5)*rad2deg,'b-','LineWidth',2);
hold on
...
subplot(3,2,6);
plot(k,xAux(:,6)*rad2deg,'r--','LineWidth',2);
hold on
plot(k,chiKK(:,6)*rad2deg,'b-','LineWidth',2);
hold on
ylabel('$\dot{\theta}_2$~(deg/s)','Interpreter','latex','FontSize',ftsize,'FontName','Times');
xlabel('Time $(s)$','Interpreter','latex','FontSize',ftsize,'FontName','Times');
ylim([-8 8]);
...
figure('units','normalized','outerposition',[0 0 1 1])
plot(k,chiKK(:,7)*rad2deg,'b',k,chiKK(:,8)*rad2deg,'r',k,chiKK(:,9)*rad2deg,'g','LineWidth',2);
ylabel('Posição Angular (rad)');
xlabel('Tempo (s)');
...
figure('units','normalized','outerposition',[0 0 1 1])
plot(k,ref(:,1)*rad2deg,'b-.',k,ref(:,2)*rad2deg,'r-.',k,ref(:,3)*rad2deg,'g-.','LineWidth',2);
ylabel('Posição Angular (rad)');
xlabel('Tempo (s)');
ylim([-5 25]);
