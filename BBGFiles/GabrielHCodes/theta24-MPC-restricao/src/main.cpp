...
clock_t t0, tend;
int numStates{4},numInput{2},numRef{2},numEstadosArtificiais{1};
mat Forces(2,1);
...
int main() {
	...
	parametros_sistema.close();
		...
		cout << "============="<< endl;
		cout << "k = 0"<< endl;
		cout << "Referencia Theta 2 [graus] "<< Ref(0,0) <<  endl;
		cout << "Referencia Theta 4 [graus] "<< Ref(1,0) <<  endl;
		cout << "============="<< endl;
		cout << "k = 300"<< endl;
