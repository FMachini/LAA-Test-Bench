...
data = load('Theta124LQT_Tilt.txt');
...
subplot(2,2,1)
hold on
plot([1:kend].*Ts,xp(3,1:end)*180/pi, 'LineWidth',2)
...
subplot(2,2,2)
plot([1:kend].*Ts,xp(1,1:end)*180/pi, 'LineWidth',2)
...
subplot(1,2,1)
hold on
plot([1:kend].*Ts, xp(2,1:end)*180/pi, 'LineWidth',2)
