...
[Ad6,Bd6,Axd6,Bxd6,Cxd6] = LinearIdentifiedModel(Ts);
Alqrd = Ad6(1:2,1:2); Blqrd = Bd6(1:2,1:2); B11d = Blqrd;
A12d = Ad6(1:2,3:end); B12d = Bd6(1:2,3:end);
A21d = Ad6(3:end,1:2); B21d = Bd6(3:end,1:2);
A22d = Ad6(3:end,3:end); B22d = Bd6(3:end,3:end);
