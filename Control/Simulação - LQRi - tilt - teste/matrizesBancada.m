...
function [Dq,Cq,Gq,nJp] = matrizesBancada(q1, q2, q3, q4, qdot1, qdot2, qdot3, qdot4)
  g = 9.81;
  m = [2.761, 0.154, 0.115, 0.559];
  l = [    0, 0.595, 0.173,     0];
  Ix= [0.004165125, 0.001006095, 0.00001723333, 0.01358627];
  Iy= [0.289994709, 0.001002423, 0.00008259913, 0.00051408];
  ...
  A = [0;0;0;0];
  A(1) = 0;
  A(2) = m(2) * g * l(2) * cos(q2) + m(3) * g * l(2) * cos(q2) + m(4) * g * l(2) * cos(q2);
  A(3) = 0;
  A(4) = 0;
  Gq = A;
