...
class Control{
	...
	private:
	mat K, Kp;
        double ekm1, ek, wkm1, wk, err, ref, dt;
        
	public:
	Control(int numStates, int numInput, double refVal, double timeSample);
	arma::mat computeOutput(arma::mat States,int cont);
	arma::mat force2duty(arma::mat forceVec, double trimForce);
        arma::mat PWM2force(arma::mat PWM);
