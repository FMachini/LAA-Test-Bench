...
Control::Control(int numStates, int numInput, int numRef, arma::mat refVal, double timeSample, double forces_trim[2], double angles_trim[2]){
	//**********************************************************
	//INICIALIZACAO
	...
	mat uMax = {1.9 - u0(0),1.9 - u0(1),15*deg2rad,15*deg2rad};
	mat uMin = {1.3 - u0(0),1.3 - u0(1),0*deg2rad,0*deg2rad};
	uMax = uMax.t();
	uMin = uMin.t();
