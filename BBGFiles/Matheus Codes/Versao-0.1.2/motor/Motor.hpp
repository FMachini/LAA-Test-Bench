...
/*
Caso deseje-se controlar o sentido de rotacao dos motores
via software na beagle bone utilizar as constantes abaixo

default_sentidoRotacaoM_numeroMotors

Diretivas para facilitar o uso do sentido de rotacao de cada motor
definido de acordo com o projeto do controlador.

Uteis para o caso quando se deseja especificar diretamente neste
codigo o sentido de rotacao do motor. Porem foi definido como
padrao do projeto que o sentido de rotacao do motor
sera definido pelos valores iniciais de 'trim' enviados pela
rotina do matlab
*/
...
/*
Os motores tambem podem ser inicializados sem a especificacao
do sentido de rotacao do motor no codigo. O sentido de rotacao
pode ser enviado atraves da rotina no MATLAB. No projeto e 
adotado esta metodologia como a padrao.
*/
...
public:
	...
	/*
	Construtor que inicializa os atributos principais do motor
	porem o sentido de rotacao do mesmo e definido na rotina
	do MATLAB
	*/
	Motor(const char *motorFilepath);
