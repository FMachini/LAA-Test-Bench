...
subplot(2,2,1)
hold on
plot([1:kend].*Ts, up(1,1:end), 'LineWidth',2)
...
subplot(2,2,3)
hold on
plot([1:kend].*Ts, up(2,1:end), 'LineWidth',2)
...
subplot(2,2,2)
hold on
plot([1:kend].*Ts, up(3,1:end)*180/pi, 'LineWidth',2)
...
subplot(2,2,4)
hold on
plot([1:kend].*Ts, up(4,1:end)*180/pi, 'LineWidth',2)
